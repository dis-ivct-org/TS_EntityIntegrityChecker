...
public class FederateIdentifierStructCoder {
    ...
    public String decodeFederateIdToDotString() {
        return Integer.toString(UnsignedDecoder.unsignedToSignedSixteeen(siteIdCoder.getValue()))
    ...
    public void setSiteIdCoderValue(int siteId) {
        siteIdCoder.setValue(UnsignedDecoder.signedToUnsign16(siteId));
    }
    ...
    public void setAppIdCoderValue(int appID) {
        appIdCoder.setValue(UnsignedDecoder.signedToUnsign16(appID));
    }
