...
public class CSVReader {
    ...
    public static List<BaseEntity> loadCSVFileToBaseEntityList(List<URL> csvFiles, Logger logger) throws IOException {
        ...
        for (int i = 0; i < csvFiles.size(); i++) {
            ...
            try (BufferedReader br = new BufferedReader(new InputStreamReader(csvFiles.get(i).openStream()))) {
                ...
                while ((line = br.readLine()) != null && !line.isEmpty()) {
                    ...
                    newEntity.setEntityIdentifier(csvItems.get(EntityHeader.ENTITY_ID.ordinal()));
                    newEntity.setEntityType(csvItems.get(EntityHeader.ENTITY_TYPE.ordinal()));
