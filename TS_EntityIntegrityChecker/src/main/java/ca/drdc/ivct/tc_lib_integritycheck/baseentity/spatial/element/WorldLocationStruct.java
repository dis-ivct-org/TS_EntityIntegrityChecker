...
public class WorldLocationStruct {
    ...
    public boolean equals(Object obj) {
        ...
        if (!MathUtils.equals(this.xPosition, other.xPosition, THRESHOLD))
            return false;
        if (!MathUtils.equals(this.yPosition, other.yPosition, THRESHOLD))
            return false;
        if (!MathUtils.equals(this.zPosition, other.zPosition, THRESHOLD))
            return false;
        return true;
    }
