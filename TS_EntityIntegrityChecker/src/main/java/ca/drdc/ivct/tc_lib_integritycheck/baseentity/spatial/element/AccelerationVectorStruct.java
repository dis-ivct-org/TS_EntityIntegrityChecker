...
public class AccelerationVectorStruct {
    ...
    public boolean equals(Object obj) {
        ...
        if (!MathUtils.equals(this.xAcceleration, other.xAcceleration, THRESHOLD))
            return false;
        if (!MathUtils.equals(this.yAcceleration, other.yAcceleration, THRESHOLD))
            return false;
        if (!MathUtils.equals(this.zAcceleration, other.zAcceleration, THRESHOLD))
            return false;
        return true;
    }
