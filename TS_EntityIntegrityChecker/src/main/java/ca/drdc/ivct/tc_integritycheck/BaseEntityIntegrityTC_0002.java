...
public class BaseEntityIntegrityTC_0002 extends AbstractTestCase {
    ...
    protected void logTestPurpose(Logger logger) {
        ...
        stringBuilder.append("Tests if a SuT federate creates BaseEntity objects with EntityTypes\n");
        ...
        stringBuilder.append("---------------------------------------------------------------------\n");
        stringBuilder.append("TC_0002 focus is to check the entities' types match.\n");
        stringBuilder.append("---------------------------------------------------------------------\n");
    ...
    protected void performTest(Logger logger) throws TcInconclusive, TcFailed {
        ...
        baseEntityDataModel.testBaseEntityIntegrityType(fad);
    }
