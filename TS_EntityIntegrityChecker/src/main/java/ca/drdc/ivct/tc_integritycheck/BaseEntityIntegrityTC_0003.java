...
public class BaseEntityIntegrityTC_0003 extends AbstractTestCase {
    ...
    protected void logTestPurpose(Logger logger) {
        ...
        stringBuilder.append("Tests if a SuT federate creates BaseEntity objects with Spatial data\n");
        ...
        stringBuilder.append("---------------------------------------------------------------------\n");
        stringBuilder.append("TC_0003 focus is to check the entities' spatial data match.\n");
        stringBuilder.append("---------------------------------------------------------------------\n");
    ...
    protected void performTest(Logger logger) throws TcInconclusive, TcFailed {
        ...
        baseEntityDataModel.testBaseEntityIntegritySpatial(fad);
    }
